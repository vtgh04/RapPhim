...
public class AddMovieDialog extends JDialog {
    ...
    private void initUI() {
        ...
        JLabel lbTitle = new JLabel("Add New Movie");
        ...
        cmbFormat.addActionListener(e -> syncLanguageWithFormat());
    ...
    /** Dialog thông báo thành công, đồng bộ màu sắc với thiết kế. */
