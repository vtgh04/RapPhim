...
public class EmployeeExcelUtils {
     ...
     */
    public static List<Employee> importFromExcel(File file, java.util.function.Consumer<Employee> saveCallback, java.util.function.Supplier<String> nextIdSupplier) throws Exception {
        ...
        try (FileInputStream in = new FileInputStream(file);
            ...
            for (int i = 1; i <= rowCount; i++) {
                ...
                // Lưu nhân viên thông qua callback
                saveCallback.accept(newEmp);
            }
        }
        return importedList;
    }
