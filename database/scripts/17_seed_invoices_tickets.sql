...
-- ============================================================
INSERT INTO dbo.invoices (invoice_id, employee_id, created_at, total_amount, total_tickets, payment_method, status, note)
VALUES ('INV002', 'EMP002', '2026-04-27 14:30:00', 675000, 4, 'CARD', 'CONFIRMED', N'Vé nhóm 4 người');

-- Ticket 3: VIP 150k×1.5=225k, giảm 10% → discount_amount=22500, final=202500
INSERT INTO dbo.tickets (ticket_id, invoice_id, show_seat_id, discount_id, barcode, original_price, discount_amount, final_price, issued_at, status)
VALUES ('TKT003', 'INV002', 'SHW010_HAL004_D4', 'DIS003', 'BC-TKT003-2026', 225000, 22500, 202500, '2026-04-27 14:30:00', 'VALID');

-- Ticket 4: VIP 225k, giảm 10% → final=202500
INSERT INTO dbo.tickets (ticket_id, invoice_id, show_seat_id, discount_id, barcode, original_price, discount_amount, final_price, issued_at, status)
VALUES ('TKT004', 'INV002', 'SHW010_HAL004_D5', 'DIS003', 'BC-TKT004-2026', 225000, 22500, 202500, '2026-04-27 14:30:00', 'VALID');

-- Ticket 5: REGULAR 150k, giảm 10% → final=135000
INSERT INTO dbo.tickets (ticket_id, invoice_id, show_seat_id, discount_id, barcode, original_price, discount_amount, final_price, issued_at, status)
VALUES ('TKT005', 'INV002', 'SHW010_HAL004_A1', 'DIS003', 'BC-TKT005-2026', 150000, 15000, 135000, '2026-04-27 14:30:00', 'VALID');

-- Ticket 6: REGULAR 150k, giảm 10% → final=135000
INSERT INTO dbo.tickets (ticket_id, invoice_id, show_seat_id, discount_id, barcode, original_price, discount_amount, final_price, issued_at, status)
VALUES ('TKT006', 'INV002', 'SHW010_HAL004_A2', 'DIS003', 'BC-TKT006-2026', 150000, 15000, 135000, '2026-04-27 14:30:00', 'VALID');

-- Cập nhật lại total_amount & total_tickets cho INV002
UPDATE dbo.invoices
SET total_amount  = (SELECT ISNULL(SUM(final_price), 0) FROM dbo.tickets WHERE invoice_id = 'INV002' AND status != 'CANCELLED'),
    total_tickets = (SELECT COUNT(*) FROM dbo.tickets WHERE invoice_id = 'INV002' AND status != 'CANCELLED')
...
-- ============================================================
INSERT INTO dbo.invoices (invoice_id, employee_id, created_at, total_amount, total_tickets, payment_method, status, note)
VALUES ('INV003', 'EMP004', '2026-04-27 16:00:00', 0, 0, 'CASH', 'PENDING', NULL);
GO
