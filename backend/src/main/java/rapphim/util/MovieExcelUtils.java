...
public class MovieExcelUtils {
     ...
     */
    public static List<Movie> importFromExcel(File file, java.util.function.Consumer<Movie> saveCallback, java.util.function.Supplier<String> nextIdSupplier) throws Exception {
        ...
        try (FileInputStream in = new FileInputStream(file);
            ...
            for (int i = 1; i <= rowCount; i++) {
                ...
                // Lưu phim thông qua callback
                saveCallback.accept(newMovie);
            }
        }
        return importedList;
    }
