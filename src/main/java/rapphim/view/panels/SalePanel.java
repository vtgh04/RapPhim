...
import rapphim.model.enums.MovieStatus;
...
public class SalePanel extends JPanel {
    ...
    private void loadSeats(Showtime st) {
        ...
        try {
            rapphim.model.CinemaHall hall = hallService.getHallById(st.getHallId());
    ...
    private JButton createSeatButton(Seat s, ShowSeatStatus status, double basePrice) {
        ...
        boolean isVip = s.getSeatType() == rapphim.model.enums.SeatType.VIP;
    ...
    private void handleCheckoutClick() {
        ...
        if ("CARD".equals(method)) {
            ...
            rapphim.view.dialogs.TransferDialog transferDialog = new rapphim.view.dialogs.TransferDialog(
    ...
    private JPanel buildTicketCard(Seat s, double price) {
        ...
        String seatType = s.getSeatType() == rapphim.model.enums.SeatType.VIP ? "VIP" : "Phổ thông";
